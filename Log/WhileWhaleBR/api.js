...
app.post("/api/selected/fun", tokenVerify, async (req, res) => {
  ...
  const code = `<section class="hoursSistem">
    ...
    <div class="renderedLabel">Serviços <strong class="GreenCard">Selecionados</strong><strong class="pointer">|</strong></div>
      <div class="renderedServices">${servicesJoin}</div>
      <div class="renderedLabel"><strong class="consoleWrite">>></strong>Escolha um profissional parceiro para  <strong class="GreenCard">prosseguir</strong>.</div><div class="renderedFunctionarys">${functionaryJoin}</div> 
    </div>
  </section>
  <footer class="selectedIndicatorA"  id="finished"><button>Continuar<strong class="consoleWrite"> >></strong></button></footer>`;
...
app.post("/api/selected/hours", tokenVerify, async (req, res) => {
  ...
  try {
    ...
    let html = `<div class="renderedHours"><div class="calendarOfHours">${hoursArray.join(
      " ",
    )}</div></div><footer class="selectedIndicatorB"  id="finished"><button>Finalizar<strong class="consoleWrite"> >></strong></button></footer>`;
...
app.get("/return/data/schedule", tokenVerify, async (req, res) => {
  ...
  <div class="call-action">
    <h1 class="call-h1">
      Nenhum agendamento <strong class="GreenCard">encontrado</strong><strong class="pointer">.</strong>
    </h1>
    <p class="call-p">Descubra lojas parceiras e agende seus serviços favoritos.</p>
  </div>

  <div class="central-plus">
    <div class="label-plus">
      <p>
        Agendar <strong class="GreenCard">Agora</strong>
      </p>
    </div>
    <div class="img-plus">
    ...
    for (let i = 0; i < schedules.length; i++) {
      ...
      if (schedule.payed) {
        ...
        <div class="union">
          ...
          <div class="schedule-Fun"><strong class="GreenCard" style="margin-bottom: 10px;">Profissional:</strong> ${functionary}</div>
          <div class="schedule-Dam">
          <strong class="GreenCard">Serviços:</strong><br><strong class="jsonWrite">{</strong><br>
    ...
    let htmlFULL = `<div class="schedule-some-div">
          ...
          <div class="label-plus">
          <p>
          Agende <strong class="GreenCard">Agora</strong>
          </p>
          </div>
          <div class="img-plus">
            <img src="https://img.icons8.com/?size=100&id=95779&format=png&color=FFFFFF">
...
app.get("/verify/have/stores", tokenVerify, async (req, res) => {
  ...
  <div class="call-action">
    <h1 class="call-h1">
      Você ainda não tem <strong class="GreenCard">lojas</strong><strong class="pointer">.</strong>
    </h1>
    <p class="call-p">Cadastre sua loja abaixo para começar a gerenciar agendamentos, serviços e equipe.</p>
  </div>

  <div class="central-plus">
    <div class="label-plus">
      <p>
        Comece sua jornada <strong class="GreenCard">Agora</strong>
      </p>
    </div>
    <div class="img-plus">
      <img src="https://img.icons8.com/?size=100&id=95779&format=png&color=FFFFFF">
...
Gerencie seus ${scheduleRemanescentes}  outros agendamentos <strong class="GreenCard">appointments</strong>
      </p>
    </div>
    <div class="img-plusI">
      ...
      const renderHtml = `
    <div class="unionE">
      <div class="welcomeDiv"><h1>Olá <strong class="consoleWrite">${finder.storeName.replaceAll(
        "/",
        " ",
      ...
      <div class="columnUnion">
        <span class="label" style="font-size:0.8em; margin:0 0 2vh 0;">Controle de abertura da <strong class="GreenCard">loja</strong><strong class="pointer">.</strong></span>
    ...
    <div class="dashboardBalance">
      <p class="test">Seu <strong class="GreenCard">balanço:</strong></p>
    ...
    <div class="todayAppointments"><p>Agendamentos do dia:</p>
    ...
    <div class="localSchedule"data-name="${finder.storeName.replaceAll(
      "/",
      "_",
    )}"><span><strong class="GreenCard">Agendamento</strong> Local</span></div>
    </div>
    <div class="unionE">
...
app.get(`/api/store/:storeName`, tokenVerify, async (req, res) => {
  ...
  try {
      ...
      for (let pd = 0; pd < name.length; pd++) {
        ...
        <div class="Basic Plan ${name[pd].replaceAll(
          ...
          <div class="beneficios">
            ...
            <button style="margin-top: 4vh;">Começar Agora</button>
          </div>
        </div>
        `;
    ...
    <section class="all-stores-info">
      <section class="storeGrandSect">
          <div class="storeData">
            ...
            <div class="infoData">
              ...
              <div class="unionE">
                <p class="adressD"><strong class="GreenCard">Endereço:</strong> ${
                  storeData.address
                }</p><p class="adressD"><strong class="GreenCard">Contato:</strong> ${storeData.phone
              ...
              <div class="functionDays"><div class="placeholder">Fechado em :</div><div class="until">${
                storeData.closedDays
              }</div></div>
              </div>
              <button class="servicesBtn"  id="toThing">Começe agore mesmo</button>
            </div>
          </div>
      ...
      ${returnS}
      <div class="selectedIndicator"><span class="counter">Serviços:</span><button>Proxímo<strong class="consoleWrite"> >></strong></button></div>
    </section>
    ${planStcr}
        `;
...
app.get("/return/data/plans", tokenVerify, async (req, res) => {
  ...
  <div class="call-action">
    <h1 class="call-h1">
      Nenhum plano <strong class="GreenCard">encontrado</strong><strong class="pointer">.</strong>
    </h1>
    <p class="call-p">Crie planos de assinatura em suas lojas favoritas.</p>
  </div>

  <div class="central-plus">
    <div class="label-plus">
      <p>
        Assinar <strong class="GreenCard">Agora</strong>
      </p>
    </div>
    <div class="img-plus">
      <img src="https://img.icons8.com/?size=100&id=95779&format=png&color=FFFFFF">
    ...
    for (let i = 0; i < finder.length; i++) {
      ...
      let div = `<div class="columnUnion planColumnUnion">
        ...
        <div class="cancel-plan"  data-name="${planName}" data-store="${dbStore}">Cancelar Plano</div>
      </div>
      `;
      htmlArray.push(div);
      havePlans = true;
...
app.get("/render/stores/plan", tokenVerify, async (req, res) => {
  ...
  <div class="call-action">
    ...
    <p class="call-p">
      Crie planos de assinatura para sua loja — de forma gratuita.  
      Saiba mais na nossa <a href="/payment-policy" class="GreenCard">Política de Pagamentos</a>.
    </p>
  </div>
  ...
  <div class="central-plus">
    <div class="label-plus">
      <p>
        Comece a assinar <strong class="GreenCard">agora</strong>
      </p>
    </div>
    <div class="img-plus">
      <img src="https://img.icons8.com/?size=100&id=95779&format=png&color=FFFFFF">
  ...
  <div class="Identifire" style="margin-bottom:5vh;">
    <h1>Planos da Sua <strong class="GreenCard">Loja</strong></h1>
    <p><strong class="consoleWrite">//</strong>Visualize os planos de assinatura e assinantes<strong class="pointer">.</strong></p>
  </div>
  <div class="dateNasc">
    <span class="label">Hoje é</span><br>
    <span class="dateSpan">${date}/${monthR}/${year}</span>
  </div>
</div>

<div class="marginer">${htmlArray.join("")}</div>

<section class="emailSect">
...
app.get("/analitics", tokenVerify, async (req, res) => {
  ...
  <div class="Identifire">
    <h1>Dashboard de <strong class="GreenCard">Análises</strong></h1>
    <p>Monitore as métricas da sua <strong class="GreenCard">loja</strong> e o engajamento dos clientes<strong class="pointer">.</strong></p>
  </div>
  <div class="dateNasc">
    <span class="label">Criada <strong class="GreenCard">em</strong></span><br>
...
<div class="unionE bottomPortraitMargin">
  <div class="analyticsInfo">
    <span class="label">Pendente de <strong class="GreenCard">recebimento:</strong></span><br>
    <span class="pricer">${formattedBalance}</span>
  </div>
  
  <div class="analyticsInfo">
    <span class="label"><strong class="GreenCard">Total</strong> de visitantes</span><br>
    <span class="Numbera">${visitantes}</span>
  </div>
  
  <div class="analyticsInfo">
    <span class="label"><strong class="GreenCard">Total</strong> de agendamentos</span><br>
    <span class="Numbera">${totalAppointments}</span>
  </div>
  
  <div class="analyticsInfo">
    <span class="label">Agendamentos <strong class="GreenCard">pagos</strong></span><br>
    <span class="Numbera">${totalAppointmentsPayed}</span>
  </div>
  
  <div class="analyticsInfo">
    <span class="label">Taxa de <strong class="GreenCard">pagamento</strong></span><br>
    <span class="Numbera">${Math.ceil(mediaDePrePagamentos)}%</span>
  </div>
  
  <div class="analyticsInfo">
    <span class="label"><strong class="GreenCard">Total</strong> de assinantes</span><br>
    <span class="Numbera">${planNumber}</span>
  </div>
  
  <div class="analyticsInfo">
    <span class="label">Agendamentos <strong class="GreenCard">cancelados</strong></span><br>
    <span class="Numbera">${Math.ceil(mediaDeCancelamentos)}%</span>
  </div>
  
  <div class="analyticsInfo">
    <span class="label">Média de <strong class="GreenCard">gasto</strong> total</span><br>
    <span class="pricer">R$ ${formatGastos}</span>
  </div>
</div>
    `;
    return res.status(200).json({
...
app.get("/prefs/render", tokenVerify, async (req, res) => {
  ...
  try {
    ...
    if (plans) {
      ...
      let html = `<div class="columnUnion">
        <div class="myPlan" style="margin: 3vh;"><div class="plan-name">Você não tem planos<div class="store-name-plan"><strong class="consoleWrite">#</strong>You</div><br></div><div class="plan-price"><strong class="consoleWrite">$</strong>00,00</div></div>
        <div class="ocultEditor"><img src="https://img.icons8.com/?size=100&id=89802&format=png&color=FFFFFF" alt="" style="width:24px; height:24px;"></div>
      </div>
      `;
      planArray.push(html);
    ...
    if (bankDatas.holder_type === "company") {
      ri = `<option value="company"> Companhia</option>
  ...
  <div class="Identifire" style="margin-bottom:5vh;">
    <h1>Preferências</h1>
    <p>
      <strong class="consoleWrite">>_</strong>Gerencie serviços, horários e configurações da loja.  
      Clique em um campo para editar<strong class="pointer">.</strong>
    </p>
  </div>
  <div class="columnUnion">
    <span class="label" style="font-size: 0.8em; margin: 0 0 2vh 0">
      Alguns dos seus <strong class="GreenCard">horários</strong><strong class="pointer">.</strong>
    </span>
  ...
  <div class="servicesTapete">
    ...
    <div class="prefservicesEditer">
      <img
        ...
        class="prefservicesEdit"
      />
      <div class="prefServicesText"><p>Editar</p></div>
    </div>
  </div>
</div>
...
<div class="unionE">
  <div class="centralize">
    <div class="Empire">
      <span class="label">
        Alguns dos seus <strong class="GreenCard">planos</strong><strong class="pointer">.</strong>
      </span>
...
<div class="columnUnion">
  <span class="label topMarginer">
    Alguns dos membros da sua <strong class="GreenCard">equipe</strong><strong class="pointer">.</strong>
  </span>
  <div class="functionaryBreaker">${functionarysArray.slice(0, 7).join("")}</div>
</div>

<div class="columnUnion">
  <span class="label">
    Seus dados <strong class="GreenCard">bancários</strong><strong class="pointer">.</strong>
  </span>
  <form action="/update/bank" method="post" style="margin-top: 5vh;">
    ...
    <input type="submit" value="Atualizar" id="bankUpdater">
  </form>
</div>
...
<div class="ofr-div">
  <div class="txt">
    <h1>
      <strong class="consoleWrite">>></strong>Editar informações da sua <strong class="GreenCard">loja</strong>
    </h1>
    <p>
      Para atualizar as <strong class="jsonWrite">informações da loja</strong>, clique em um campo e faça as alterações.<strong class="pointer">.</strong>
    </p>
...
app.get("/obsolence/rend", tokenVerify, async (req, res) => {
  ...
  <div class="obsolenceDiv-text">
    <div class="obsolenceDiv-titles">
      <h1>
        Modo de <strong class="jsonWrite">Obsolescência</strong> da Loja
      </h1>
    </div>
    <div class="obsolenceDiv-instructions">
      <p>
        Ao ativar o Modo de Obsolescência, novos agendamentos serão
        <strong class="jsonWrite">imediatamente desativados</strong> e sua assinatura será cancelada. 
        Sua loja permanecerá ativa por
        <strong class="jsonWrite">32 dias</strong> para concluir todos os agendamentos já marcados, após o que todos os dados serão
        <strong class="jsonWrite">excluídos permanentemente</strong>.
        Esta ação é irreversível e não pode ser desfeita em nenhuma circunstância<strong class="pointer">.</strong>
      </p>
    </div>
  </div>
  <div class="obsolenceDiv-call">
    ...
    />
      ...
      stcr = `<div class="unionE">
  <div class="Identifire">
    <h1>
      <strong class="consoleWrite">${obs.storeName.replaceAll("/", " ")}</strong> está obsoleta
    </h1>
    <p>Iniciou em ${d} e termina em ${f}</p>
  </div>
  <div class="dateNasc">
    <span class="label">Encerra <strong class="GreenCard">em</strong></span><br>
    <span class="dateSpan">${f}</span>
  </div>
</div>

<div class="unionE" style="margin-left:5vw;">
  <div class="analyticsInfo">
    <span class="label"><strong class="GreenCard">  Agendamentos</strong> restantes</span><br>
    <span class="Numbera">${visitantes}</span>
  </div>
  <div class="analyticsInfo">
    <span class="label"><strong class="GreenCard">Total</strong> de dias restantes</span><br>
    <span class="Numbera">${diasRestantes}</span>
  </div>
</div> `;
    }
